...
func InsertAdvanceFinance(DP DataPerusahaan.Keuangan) models.BaseResponseModels {
	var query string
...
func UpdateAdvanceFinance(DP DataPerusahaan.Keuangan) models.BaseResponseModels {
	var query string
	var result models.BaseResponseModels
	db := connection.DB
...
func DeleteAdvanceFinance(request DataPerusahaan.Keuangan) models.BaseResponseModels {
	var query string
	var result models.BaseResponseModels
	db := connection.DB
...
func GetAdvanceFinanceByID(request DataPerusahaan.Keuangan) models.BaseResponseModels {
	var query string
	var result models.BaseResponseModels
